...
class MainPage(BasePage):
    def login_popup(self):  # ГОТОВ
        time.sleep(20)

        button = WebDriverWait(self.browser, 10).until(EC.element_to_be_clickable((By.ID, "login")))
        button.click()

        self.browser.find_element(By.CLASS_NAME, "login")
    ...
    def login_vk(self):  # ГОТОВ
        ...
        self.browser.find_element(By.CLASS_NAME, "popup--login")
        button1 = self.browser.find_element(By.CLASS_NAME, "js-vk-login")
        button1.click()
        input1 = self.browser.find_element(By.NAME, "email")
        input1.send_keys("79158330682")
        input2 = self.browser.find_element(By.NAME, "pass")
        input2.send_keys("qwerty1999qaz1000")
    ...
    def item_region(self):  # ГОТОВ
        time.sleep(20)

        button = WebDriverWait(self.browser, 10).until(EC.element_to_be_clickable(
            (By.XPATH, "/html/body/div[2]/header/div[2]/div/ul[2]/li/span")))
        button.click()

        elem = self.browser.find_element(By.XPATH, "/html/body/div[2]/noindex/div/div/div[1]/div[1]/a[2]")
        elem.click()
    ...
    #
    # def pere_links(self):
    #     self.browser.find_element(By.XPATH, "/html/body/div[2]/main/div/div[3]/div[1]/ul")
    ...
    def find_ipoteka_link(self):  # ГОТОВ
    ...
    def find_element_button(self):
        ...
        self.browser.find_element(By.CLASS_NAME, "cpopup__win")
    ...
    def check_subscription_popup(self):
        ...
        self.browser.find_element(By.XPATH, "/html/body/div[2]/main/div/div[3]/div[8]/div")
    ...
    def check_subscription_hand_popup(self):
        self.browser.execute_script("window.scrollBy(1200, 1200);")  # РАССЧИТАТЬ ПИКСЕЛЬНЫЙ СКРОЛЛ
        WebDriverWait(self.browser, 20).until(EC.element_to_be_clickable(
